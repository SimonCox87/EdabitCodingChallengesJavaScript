...
//     The term "within bounds" means a number is considered equal or greater than a lower bound and lesser (but not equal) to an 
...
const intWithinBounds = (n,lower,upper) => !(n%1) && n>=lower && n<upper;
